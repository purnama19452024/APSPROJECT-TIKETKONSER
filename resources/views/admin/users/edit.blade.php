...
<div class="max-w-lg">
    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 space-y-5">
        @csrf @method('PUT')
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Password <span class="text-gray-500 font-normal">(kosongkan jika tidak ingin ganti)</span></label>
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-3">
                <label class="relative">
                    <input type="radio" name="role" value="user" class="sr-only peer" {{ old('role', $user->role) == 'user' ? 'checked' : '' }}>
