    ...
    <form method="POST" action="{{ route('admin.concerts.store') }}" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="datetime-local" name="ticket_expiry" value="{{ old('ticket_expiry') }}" class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
